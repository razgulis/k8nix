...

{
  ...
  users.users.admin = {
    ...
    openssh.authorizedKeys.keys = [
      ...
      "sk-ssh-ed25519@openssh.com AAAAGnNrLXNzaC1lZDI1NTE5QG9wZW5zc2guY29tAAAAIOPlUfZEZKZzZOnROBmYiYsVONPqG/hIU3Tjf3rM1fxjAAAAEXNzaDprOG5peC1jbHVzdGVy sergei@tortuga"
    ];
  };
